...
#define STRING_CONFIG_H_AUTHOR "(zeronearhero, CR-10 S5 SKR E3 V2.0 w/ Included Touchscreen)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 S5 SKR E3 V2.0"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 320, 800, 138.6 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -0.71 }
